...
declare function bind<T1>(
  d1: StateView<T1>,
  f: (v1: T1, dom: Element, oldV1: T1) => Primitive | Node | null | undefined
): Node | [];
declare function bind<T1, T2>(
  d1: StateView<T1>,
  d2: StateView<T2>,
  f: (
    v1: T1,
    ...
    oldV1: T1,
    oldV2: T2
  ) => Primitive | Node | null | undefined
): Node | [];
declare function bind<T1, T2, T3>(
  d1: StateView<T1>,
  d2: StateView<T2>,
  d3: StateView<T3>,
  f: (
...
declare function bind<T1, T2, T3, T4>(
  d1: StateView<T1>,
  d2: StateView<T2>,
  d3: StateView<T3>,
  d4: StateView<T4>,
...
declare function bind<T1, T2, T3, T4, T5>(
  d1: StateView<T1>,
  d2: StateView<T2>,
  d3: StateView<T3>,
  d4: StateView<T4>,
...
declare function bind<T1, T2, T3, T4, T5, T6>(
  d1: StateView<T1>,
  d2: StateView<T2>,
  d3: StateView<T3>,
  d4: StateView<T4>,
...
declare function bind<T1, T2, T3, T4, T5, T6, T7>(
  d1: StateView<T1>,
  d2: StateView<T2>,
  d3: StateView<T3>,
  d4: StateView<T4>,
...
declare function bind<T1, T2, T3, T4, T5, T6, T7, T8>(
  d1: StateView<T1>,
  d2: StateView<T2>,
  d3: StateView<T3>,
  d4: StateView<T4>,
...
declare function bind<T1, T2, T3, T4, T5, T6, T7, T8, T9>(
  d1: StateView<T1>,
  d2: StateView<T2>,
  d3: StateView<T3>,
  d4: StateView<T4>,
...
declare function bind<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(
  d1: StateView<T1>,
  d2: StateView<T2>,
  d3: StateView<T3>,
  d4: StateView<T4>,
